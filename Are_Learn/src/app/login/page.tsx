      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-grey-600">
            Ou{' '}
            <Link href="/cadastro" className="font-medium text-gold-500 hover:text-gold-600">
              crie uma nova conta
            </Link>
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/recuperar-senha" className="font-medium text-gold-500 hover:text-gold-600">
                  Esqueceu a senha?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-grey-50 text-grey-500">Ou continue com</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2 px-4 border border-grey-300 rounded-lg shadow-sm bg-white text-sm font-medium text-grey-500 hover:bg-grey-50"
              >
